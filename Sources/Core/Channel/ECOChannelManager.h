...
typedef void(^ECOChannelAuthStateChangedBlock)(ECOChannelDeviceInfo *device, BOOL authState);
typedef void(^ECOChannelRequestAuthStateBlock)(ECOChannelDeviceInfo *device, BOOL authState);
