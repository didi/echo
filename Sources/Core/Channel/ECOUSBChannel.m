...
- (void)connectToLocalIPv4Port {
    ...
    [channel connectToPort:ECOUSBChannelIPv4PortNumber IPv4Address:INADDR_LOOPBACK callback:^(NSError *error, PTAddress *address) {
        if (error) {
...
- (void)connectToUSBDevice {
    ...
    [channel connectToPort:ECOUSBChannelIPv4PortNumber overUSBHub:PTUSBHub.sharedHub deviceID:self.connectingToDeviceID callback:^(NSError *error) {
        if (error) {
